...
namespace rmrt {
	...
	Sphere::Sphere(Point3 center, float radius, std::shared_ptr<Material> material)
		: m_center(center), m_radius(radius), m_radiusSquared(m_radius * m_radius), m_materialPtr(material) { }
	...
	MovingSphere::MovingSphere(Point3 center0, Point3 center1, float time0, float time1, float radius, std::shared_ptr<Material> material)
		: m_center0(center0), m_center1(center1), m_time0(time0), m_time1(time1), m_radius(radius), m_radiusSquared(radius * radius), m_materialPtr(material),
		  m_centerDelta(center1 - center0), m_timeDelta(time1 - time0) { }
